...
public class XunFeiManager : MonoBehaviour
{
    ...
    private const string APPID = "4c846351";
    /// <summary>改成你自己的APISecret!!!!!!</summary>
    private const string APISecret = "ZTg3ODg5ZTdjZTU3NGI5MmU2OTUzYTJh";
    /// <summary>改成你自己的APIKey!!!!!!</summary>
    private const string APIKey = "de380814aeae4685e490fc010ec853ad";
